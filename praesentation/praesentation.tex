...
Summe	& 	1035	& 	1067	& 2102\\
 ...
 \resizebox {0.9\columnwidth} {!} {
	...
	\begin{frame}
	  \frametitle{Aufgabe 3.3: Variation der Feature-Anzahl\\ Siehe Datei 3.3result.csv\\ Genauigkeit}
	  ...
	  %\begin{minipage}[\textheight]{\textwidth}
	    ...
	    \item ...oder $\approx2500$, weil danach die Genauigkeit nicht wesentlich steigt
	    \end{itemize}
	    \end{column}
	...
	\begin{frame}
	  ...
	  \begin{columns}[T]%T
	    ...
	    \begin{itemize}[] %<+->
	    \item Trainingsdauer steigt von Ausreißern abgesehen weniger als linear an
